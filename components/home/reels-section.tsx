    ...
    <section className="py-12 md:py-16">
      <div className="container mx-auto px-4">
        <div className="mb-6 flex items-center justify-between">
          ...
          <Link href="/reels" className="text-sm font-medium text-accent hover:underline">
            View All
          </Link>
        </div>
        ...
        <div className="scrollbar-hide -mx-4 flex gap-4 overflow-x-auto px-4 pb-4 md:mx-0 md:px-0">
          {reels.map((reel) => (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group w-[160px] flex-shrink-0 md:w-[200px]"
            >
              <div className="relative aspect-[9/16] overflow-hidden rounded-2xl bg-secondary">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="flex size-12 items-center justify-center rounded-full bg-background/20 backdrop-blur-sm transition-transform group-hover:scale-110">
                    <Play className="ml-0.5 size-5 fill-white text-white" />
                  </div>
                </div>

                <div className="absolute bottom-0 left-0 right-0 p-3">
                  <p className="mb-1 line-clamp-2 text-sm font-medium text-white">{reel.title}</p>
                </div>
              </div>
            </a>
          ))}
